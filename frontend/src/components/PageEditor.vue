...
function handleAddPage() {
  ...
  store.addPage({ id: Date.now(),  json:null, image })
...
<template>
  <div class="editor-wrapper container px-3">
      ...
      <div class="col-12 col-lg-3">
        <div class="card shadow-sm p-3 border-0 h-100">
          <div class="mb-3">
            ...
            <input type="file" class="form-control" @change="handleImageUpload" ref="fileInput" :disabled="currentPageIndex"/>
          </div>

          <div class="mb-3">
            <label class="form-label fw-semibold">頁面文字</label>
            <textarea v-model.trim="text" rows="3" class="form-control" @keyup.enter="handleAddText" :disabled="currentPageIndex"/>
          </div>
